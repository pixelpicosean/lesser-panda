...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  // Use Timers instead of browser time functions
  var setTimeout = function setTimeout(fn, time) {
    return Timer.later(time, fn);
  };
  var clearTimeout = function clearTimeout(timer) {
    Timer.remove(timer);
  };
  var setInterval = function setInterval(fn, time) {
    return Timer.interval(time, fn);
  };
