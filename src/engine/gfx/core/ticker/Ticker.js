...
/**
 * Calls {@link module:event-emitter.EventEmitter#on} internally for the
...
/**
 * Calls {@link module:event-emitter.EventEmitter#once} internally for the
 * internal 'tick' event. It checks if the emitter has listeners,
 * and if so it requests a new animation frame at this point.
 *
...
/**
 * Calls {@link module:event-emitter.EventEmitter#off} internally for 'tick' event.
